...
AGENT_SYSTEM_PROMPT = (
    ...
    "Once retrieve() returns non-empty context, proceed IMMEDIATELY to Step 2 — "
    "do NOT call rewrite() again after retrieve(). "
    ...
    "If context is already sufficient: skip Step 1 and proceed to Step 2.\n\n"
