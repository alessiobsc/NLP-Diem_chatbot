...
AGENT_SYSTEM_PROMPT = (
    ...
    "You MUST call rewrite() or retrieve() at least once before proceeding to Step 2 — "
    "never generate an answer without having called at least one tool. "
    "do NOT call rewrite() again after retrieve() has returned context. "
    "If context is empty or irrelevant, retry with a rephrased or broader query. "
